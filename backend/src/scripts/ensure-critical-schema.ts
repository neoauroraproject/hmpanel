...
export async function ensureCriticalSchema(prisma: PrismaClient): Promise<void> {
  const statements = [
    ...
    `DO $$ BEGIN CREATE TYPE "AgencyPlanKind" AS ENUM ('TOP_UP', 'NEW_AGENCY', 'BOTH'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
    `DO $$ BEGIN CREATE TYPE "AgencyOrderKind" AS ENUM ('TOP_UP', 'NEW_AGENCY'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
    ...
    // Provider access + multi-line agency orders
    ...
    `CREATE INDEX IF NOT EXISTS "AdminRechargeOrderLineItem_orderId_sortOrder_idx" ON "AdminRechargeOrderLineItem"("orderId", "sortOrder")`,
    `CREATE INDEX IF NOT EXISTS "AdminRechargeOrderLineItem_status_idx" ON "AdminRechargeOrderLineItem"("status")`,
    ...
    `CREATE INDEX IF NOT EXISTS "AdminProviderAccess_adminId_idx" ON "AdminProviderAccess"("adminId")`,
    `CREATE INDEX IF NOT EXISTS "AdminProviderAccess_provider_enabled_idx" ON "AdminProviderAccess"("provider", "enabled")`,
