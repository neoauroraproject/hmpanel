...
export const STORE_PAYMENT_METHOD_TELEGRAM_WALLET_SQL = `
DO $$ BEGIN
  ALTER TYPE "StorePaymentMethod" ADD VALUE IF NOT EXISTS 'TELEGRAM_WALLET';
EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_object THEN NULL;
END $$
`.trim();
...
export const PAYMENT_LEDGER_MIGRATION_SQL = [
  ...
  STORE_PAYMENT_METHOD_TELEGRAM_WALLET_SQL,
