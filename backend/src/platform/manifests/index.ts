...
export const MODULE_MANIFESTS: ModuleManifest[] = [
  ...
  },
  {
    ...
    name: 'Other Panels',
    version: '1.0.0',
    description: 'Connect and manage Eylan and Pasarguard panel clients.',
    kind: 'BUSINESS',
    phase: 2,
    defaultEnabled: false,
    licenseRequirement: 'business',
    ...
    dependencies: [],
    permissions: [
      { id: 'external-panels.view', description: 'View external panel clients' },
      { id: 'external-panels.manage', description: 'Manage external panel clients', write: true },
    ],
    routes: { backend: '/premium-modules/external-panels', frontend: '/premium/external-panels' },
    menus: [{ label: 'Other Panels', path: '/premium/external-panels', icon: 'Layers' }],
    scheduler: [],
    readOnlyCapabilities: {
      read: ['view_connections', 'view_clients'],
      write: ['manage_connections', 'manage_clients'],
    },
  },
  {
    id: 'admin-recharge',
