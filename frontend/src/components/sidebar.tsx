...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-60 flex-col border-e border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 md:flex">
      ...
      <div className="mt-auto border-t border-zinc-200 p-3 dark:border-zinc-800">
        ...
        {admin?.role === "SUPER_ADMIN" && (
          <div className="px-2 pb-2">
            <a
              ...
              className="flex items-center gap-2 text-xs text-zinc-500 transition-colors hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200"
            >
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-zinc-500 transition-colors hover:bg-zinc-50 hover:text-red-400 dark:text-zinc-400 dark:hover:bg-zinc-900/50"
        >
          <LogOut size={18} />
          {t("nav.logout")}
        </button>
