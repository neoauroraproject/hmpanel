...
const MODULE_ID_TO_NAV: Record<string, string> = {
  ...
  store: "nav.store",
  "store-digital": "nav.storeDigital",
  "store-payg": "nav.storePayg",
...
const HREF_TO_NAV: Record<string, string> = {
  ...
  "/premium/store-digital": "nav.storeDigital",
  "/premium/store-payg": "nav.storePayg",
  "/premium/payment-management": "nav.paymentManagement",
