      ...
      <div className="relative z-10 mx-auto flex w-full max-w-lg flex-col gap-6 px-4 py-8 sm:px-6">
        ...
        <section className="flex gap-2">
          <button
            ...
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#ff6a1a] px-4 py-3.5 text-sm font-extrabold text-[#1a0c04] transition hover:bg-[#ff812f]"
          >
          ...
          {ps.showPlatformQR !== false ? (
            <button
              ...
              className="inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-[#ff6a1a]/40 bg-[#1c1814] text-[#ff6a1a]"
              aria-label="QR"
            >
              <QrCode size={18} />
            </button>
