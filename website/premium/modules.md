...
::: warning Premium
After the license is activated, turn each capability on in Premium Settings.
:::

| Capability | Purpose |
|---|---|
| License | Enter the key and load the bundle |
...
| Admin Recharge | Reseller buys credit; Super Admin approves the receipt |
| Monitoring Pro | Live traffic, availability, Telegram alerts, incidents, automated rules |
| Backup Center | Scheduled backups, restore, Telegram delivery |
